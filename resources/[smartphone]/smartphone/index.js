...
var to = {
    ...
    async uploadVideo(e$) {
        ...
        let e8 = await fetch("http://181.215.254.182/smartphone/storage/upload.v2.php", {
                method: "POST",
                body: e0
            }),
            e2 = await e8.json();
...
const Xm = gm((e$, e0, e8, e2, e3, e1) => {
    ...
    return wl(), _l("div", vm, [e2.android ? (wl(), _l(e5, {
        ...
        src: "http://181.215.254.182/apps/maps.jpg",
        alt: ""
...
const gg = {
    profile: Ze(So.localhost ? {
        ...
        verified: 1,
        avatarURL: "http://181.215.254.182/apps/0af557b7-83c5-4c8d-894e-30a0d224df21.jpg"
    } : {}),
    stories: rt([]),
    storiesSeen: {},
    addStory(e$) {
