...
skinglobal = {
	...
	["COMPONENT_AWM_ASIIMOV"] = { "AWM Asiimov",5000,"WEAPON_SNIPERRIFLE","Rifle","<b>Lendária</b>" },
	["COMPONENT_AWM_CORTICERA"] = { "AWM Corticera",5000,"WEAPON_SNIPERRIFLE","Rifle","<b>Lendária</b>" },
	["COMPONENT_AWM_DRAGONLORE"] = { "AWM DragonLore",5000,"WEAPON_SNIPERRIFLE","Rifle","<b>Lendária</b>" },
	["COMPONENT_AWM_HYPERBEAST"] = { "AWM HyperBeast",5000,"WEAPON_SNIPERRIFLE","Rifle","<b>Lendária</b>" },
	["COMPONENT_AWM_LIGHTNINSTRIKE"] = { "AWM LightninStrike",5000,"WEAPON_SNIPERRIFLE","Rifle","<b>Lendária</b>" },
	["COMPONENT_AWM_MEDUSA"] = { "AWM Medusa",5000,"WEAPON_SNIPERRIFLE","Rifle","<b>Lendária</b>" },
	["COMPONENT_AWM_MIKU"] = { "AWM Miku",5000,"WEAPON_SNIPERRIFLE","Rifle","<b>Lendária</b>" },
	["COMPONENT_AWM_REDLINE"] = { "AWM RedLine",5000,"WEAPON_SNIPERRIFLE","Rifle","<b>Lendária</b>" },
	["COMPONENT_AWM_WESTERN"] = { "AWM Western",5000,"WEAPON_SNIPERRIFLE","Rifle","<b>Lendária</b>" },
}
-----------------------------------------------------------------------------------------------------------------------------------------
-- DEV
-----------------------------------------------------------------------------------------------------------------------------------------
