$(document).ready(function (){
	...
	function goback(){
		var gobackbutton = (`<button style="background: #8B0000;" id="goback" class="btn"><div class="title">Voltar</div><i class="fas fa-chevron-left icon" style="top:40%;right: 20px"></i></button>`);
