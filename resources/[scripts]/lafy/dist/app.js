const qn = function () {
  ...
  function nn(t, e, { bubbles: r = false, cancelable: n = false } = {}) {
  ...
  `
    ...
    m[d] ||
      ((m[d] = true), _.insertRule(`@keyframes ${d} ${c}`, _.cssRules.length))
  ...
  function Jt() {
    ...
    do {
      ...
      for (ke(null), Je.length = 0, it = 0; jt.length;) {
        jt.pop()()
      }
  ...
  function ii(t, e, r) {
    ...
    function u() {
      ...
      l = tn((y) => {
        if (i) {
          if (y >= k) {
            return m(1, 0), Ye(t, true, 'end'), o(), (i = false)
          }
          if (y >= b) {
            const T = _((y - b) / p)
            m(T, 1 - T)
    ...
    return {
      start() {
        c || ((c = true), Lt(t), Se(n) ? ((n = n()), cn().then(u)) : u())
      },
      invalidate() {
        c = false
      },
  ...
  function lr(t, e) {
    ...
    if (Vn(t)) {
      ...
      if (
        ...
        return n(e.pending, 0), true
      }
    } else {
      if (e.current !== e.then) {
        return n(e.then, 1, e.value, t), true
      }
      e.resolved = t
    }
  }
  ...
  class de {
    ...
    $set(e) {
      this.$$set &&
        !Jn(e) &&
        ((this.$$.skip_bound = true), this.$$set(e), (this.$$.skip_bound = false))
    }
  }
  const Pe = []
  function hn(t, e) {
  ...
  const Wt = hn(null, function (e) {
    ...
    return (
      ...
      function () {
        window.removeEventListener('hashchange', r, false)
      }
    )
  }),
  ...
  function mi(t, e, r) {
    let { routes: n = {} } = e,
      { prefix: i = '' } = e,
      { restoreScrollState: s = false } = e
    class l {
      constructor(S, v) {
        if (
          !v ||
          (typeof v != 'function' &&
            (typeof v != 'object' || v._sveltesparouter !== true))
        ) {
    ...
    Vt(() => {
      k()
      m && window.removeEventListener('popstate', m)
    })
    function y(E) {
      Nt.call(this, t, E)
    }
  ...
  function Ci(t) {
    return (
      ...
      ((typeof FormData == 'function' && t instanceof FormData) ||
        Yt.call(t) === '[object FormData]' ||
        (Qt(t.toString) && t.toString() === '[object FormData]'))
    )
  }
  ...
  Object.defineProperty(xn, 'isAxiosError', { value: true })
          ...
          if (!be.isUndefined(o)) {
            ...
            if (o && !l && typeof o == 'object') {
              if (be.endsWith(u, '{}')) {
                ...
                if (be.endsWith(u, '[]') && (d = be.toArray(o))) {
  ...
  Gi.inherits(Rn, zt, { __CANCEL__: true })
  var _t = Rn,
    Qi = function (e) {
      var r = /^([-+\w]{1,25})(:?\/\/|:)/.exec(e)
      return (r && r[1]) || ''
    ...
    dr = function (e) {
      return new Promise(function (n, i) {
        ...
        c.open(e.method.toUpperCase(), ts(_, e.params, e.paramsSerializer), true)
        c.timeout = e.timeout
        function m() {
          if (!!c) {
            var k =
        ...
        if (
          ('onloadend' in c
            ...
            (c.onerror = function () {
              i(new ve('Network Error', ve.ERR_NETWORK, e, c, c))
              c = null
            }),
        ...
        typeof e.onUploadProgress == 'function' &&
          ...
          ; (e.cancelToken || e.signal) &&
            ((o = function (k) {
              !c || (i(!k || (k && k.type) ? new ls() : k), c.abort(), (c = null))
            }),
  ...
  ze.prototype.request = function (e, r) {
    ...
    this.interceptors.request.forEach(function (_) {
      ; (typeof _.runWhen == 'function' && _.runWhen(r) === false) ||
  ...
  var Rs = Be,
    ...
    Ps = ie,
    Ts = function (e) {
      return Ps.isObject(e) && e.isAxiosError === true
    },
    yr = ie,
    $s = _n,
    ct = Cs,
  ...
  const Ze = He('isMuted', false),
    ht = He('volume', 50),
    jn = He('localVolume', 100),
    Oe = He('lastPlayed', '"migrated"', false),
    me = He('likes', '"migrated"', false),
    we = He('playlists', '"migrated"', false),
    X = js.create({
      // -- Coloca o ip da VPS no campo abaixo..
      baseURL: 'http://181.215.254.182:3000/client',
      headers: {},
    })
  ...
  function kt(t, e) {
    ...
    ).then((r) => (Oe.set(r.data.last_played), r))
  }
  function Fs(t, e) {
    Oe.update((r) => {
  ...
  let Ut = 0
  async function rt(t = [], e = false) {
    if (t.length === 0) {
      return Ee.set('Não é possível tocar uma playlist vazia.')
    }
    const r = {}
    try {
      ...
      Ee.set('Não foi possivel salvar a música, tente novamente .🎶')
    }
    Ze.set(false)
    let n = t.shift()
    e && t.push(n)
    ...
    if (Ke && i?.mode == 'dj' && (await J('server', 'next', l.url))) {
      s = 'dj'
    } else {
      if (i != null && !Ke && (await J('server', 'next', l.url))) {
        s = i.mode
      } else {
  
        const a = await J('getVehicle'),
          { mode: o, error: u } = await (Ke
            ? await J('server', 'play_dj', Ke - 1, l.url, pe(ht) / 100) : await J('server', 'play', a, l.url, pe(ht) / 100))
        if (u) {
          return Ee.set(u)
        }
        s = o
  ...
  function Fn(t) {
    ...
    t.audio.paused &&
      (t.audio.play().catch(() => { }),
        (t.audio.currentTime = (Ie() - t.created_at) / 1000))
  ...
  function Ys(t) {
    ...
    t.audio.addEventListener('ended', () => Un?.(t.id), { once: true })
    Fn(t)
    Ue[t.id] = t
  }
  function Xs(t) {
  ...
  function tl() {
    Ee.set('Emparelhamento encerrado: dispositivo fora de alcance.')
    W.set()
  }
  function It(t) {
    Ke = t
  ...
  function ll(t) {
    ...
    return {
      c() {
        e = w('div')
        e.innerHTML = '<i class="fal fa-spinner-third text-5xl animate-spin"></i>'
        h(e, 'class', 'absolute inset-0 grid place-items-center bg-black/50 z-10')
      },
      m(i, s) {
        M(i, e, s)
        n = true
  ...
  function Sr(t) {
    ...
    return {
      c() {
        e = w('p')
        e.textContent =
          'Na área em que você se encontra, não é possível tocar ou escutar músicas.'
    ...
    return {
      ...
      p(l, a) {
        if (a & 240) {
          ...
          for (G(), o = n.length; o < i.length; o += 1) {
            s(o)
          }
          Q()
        }
  ...
  function ml(t) {
    ...
    return {
      c() {
        e = w('div')
        e.innerHTML = '<i class="fas fa-spinner-third animate-spin text-4xl"></i>'
  ...
  function hl(t) {
    let e,
      ...
      D,
      I,
      O = t[2].interior === 'blocked' && Sr()
    g = new Et({ props: { class: 'rounded' } })
    let P = t[1].slice(0, 5),
      z = []
    ...
    return (
      lr(($ = t[6]), C),
      {
        c() {
          ...
          b = R()
          k = w('h1')
          k.textContent = 'Músicas Curtidas'
          y = R()
          ...
          h(
            o,
            'class',
            (u = 'fal w-6 ' + (t[3] ? 'fa-volume-slash' : 'fa-volume'))
          )
          ...
          Gn(
            e,
            'background-image',
            'linear-gradient(170deg, rgba(202, 0, 0, 0.8), #0f0f0f 20%)'
          )
        },
        m(L, B) {
          M(L, e, B)
          ...
          f(E, S)
          f(E, v)
          C.block.m(E, (C.anchor = null))
          C.mount = () => E
          C.anchor = null
          x = true
          D || ((I = H(a, 'click', t[9])), (D = true))
        },
        p(L, [B]) {
          if (
            ((t = L),
              t[2].interior === 'blocked'
                ? O || ((O = Sr()), O.c(), O.m(e, r))
                : O && (O.d(1), (O = null)),
              (!x || B & 1) && te(s, t[0]),
              (!x ||
          ...
          C.ctx = t
            ; (B & 64 && $ !== ($ = t[6]) && lr($, C)) || si(C, t, B)
        },
        i(L) {
          x || (N(g.$$.fragment, L), N(C.block), (x = true))
        },
        o(L) {
          U(g.$$.fragment, L)
          for (let B = 0; B < 3; B += 1) {
  ...
  function gl(t, e, r) {
    ...
    d.getHours() >= 12 && d.getHours() <= 18
      ? (p = 'thunder CITY')
      : (d.getHours() < 5 || d.getHours() > 18) && (p = 'thunder CITY')
    async function _(b) {
  ...
  function _l(t) {
    ...
    return {
      ...
      m(S, v) {
        ...
        f(e, b)
        f(e, k)
        y || ((T = [H(k, 'click', t[4]), H(e, 'click', t[3])]), (y = true))
      },
      p(S, [v]) {
        v & 1 && !Y(r.src, (n = S[0].image_url)) && h(r, 'src', n)
        v & 1 && a !== (a = S[0].name + '') && (l.innerHTML = a)
        v & 2 &&
          o !== (o = 'text-base whitespace-nowrap ' + (S[1] && 'text-spotify')) &&
          h(l, 'class', o)
        S[0].is_explicit
          ? E || ((E = Rr()), E.c(), E.m(c, d))
          : E && (E.d(1), (E = null))
  ...
  function yl(t) {
    ...
    return {
      c() {
        ...
        h(a, 'placeholder', 'Artistas, músicas, ou podcasts')
        h(i, 'class', 'relative')
        h(e, 'class', 'p-5 pt-12')
      },
      m(m, g) {
        ...
        M(m, u, g)
        c = true
        d || ((p = [H(a, 'input', t[4]), H(a, 'keydown', t[2])]), (d = true))
      },
      p(m, [g]) {
  ...
  function xl(t) {
    ...
    return {
      c() {
        ...
        h(m, 'class', 'flex flex-col w-full space-y-3 mt-5 px-10 overflow-y-auto')
        h(
          e,
          'class',
      ...
      m(C, L) {
        ...
        O = true
        P ||
          ((z = [H(n, 'click', t[9]), H(g, 'click', t[5]), H(D, 'click', t[6])]),
            (P = true))
      },
      p(C, L) {
  ...
  function El(t) {
    ...
    return {
      c() {
        e = w('div')
        r = w('h1')
        r.textContent = 'Dê um nome para sua playlist.'
        n = R()
        i = w('div')
        s = w('input')
        l = R()
      ...
      m(g, b) {
        ...
        p = true
        _ ||
          ((m = [H(s, 'input', t[7]), H(o, 'click', t[8]), H(c, 'click', t[4])]),
            (_ = true))
      },
      p(g, b) {
  ...
  function Sl(t) {
    ...
    return {
      c() {
        ...
        _ = w('div')
        m = w('h1')
        m.textContent = 'Músicas Curtidas'
        g = R()
        b = w('p')
        k = V('Playlist \u2022 ')
        T = V(y)
  ...
  function Cl(t, e, r) {
    ...
    async function a() {
      ...
      we.update((b) => b.concat(g.data))
      r(3, (s = null))
    }
    async function o() {
      await kt('PLAYLIST', l._id)
      await rt(l.songs.slice())
      r(0, (l = null))
    }
    async function u() {
  ...
  function jr(t) {
    ...
    return {
      ...
      m(v, $) {
        ...
        f(m, k)
        T = true
        E || ((S = [H(g, 'click', t[12]), H(a, 'submit', t[8])]), (E = true))
      },
      p(v, $) {
  ...
  function Nl(t, e, r) {
    ...
    async function y(x) {
      ...
      if (I) {
        ...
        if (!P.headers.get('content-type').includes('image/')) {
          return
        }
        r(1, (d.image_url = I), d)
      }
  ...
  function Br(t) {
    ...
    return {
      c() {
        ...
        i = R()
        s = w('h1')
        s.textContent = 'Adicionar à Playlist'
        l = R()
        a = w('ul')
        ...
        h(s, 'class', 'absolute inset-x-20 font-bold text-center')
        h(r, 'class', 'absolute top-5 inset-x-5 flex')
        h(a, 'class', 'flex flex-col w-full space-y-3 mt-5 px-10 overflow-y-auto')
        h(
          e,
          'class',
          'absolute inset-0 bg-black z-20 pt-12 flex flex-col items-center'
      ...
      return vr(async () => {
        if (i.paused_at) {
          ...
          if (i.mode === 'dj') {
            ...
            Le(W, (i.paused_at = Ie()), i)
            await J('server', g ? 'stop' : 'pause')
          }
        }
      })
    }
  ...
  function Jl(t, e, r) {
    ...
    return (
      sn(async () => {
        ...
        if (
          (s !== 'migrated' && s.length
            ? (r(0, (l = 'Migrando suas músicas curtidas...')),
        ...
        n !== 'migrated' && n.length
          ? (r(0, (l = 'Migrando seu histórico...')),
            await he(() => X.put('history', { last_played: n })),
            Oe.save('migrated'),
            r(0, (l = 'Finalizando migração...')),
            await vt(1500),
            Ee.set(
              'Agora todas as suas playlists e curtidas serão sincronizadas em todas as cidades que você jogar.'
            ))
          : Oe.set(o.history.last_played)
        Ge('/home')
      }),
  ...
  function Kl(t) {
    ...
    return {
      ...
      m(l, a) {
        ...
        r = true
        n ||
          ((i = [H(Wr, 'keydown', t[3]), H(Wr, 'contextmenu', t[4])]), (n = true))
      },
      p(l, [a]) {
        l[0]
          ? s
  ...
  function Yl(t, e, r) {
    ...
    function o(c) {
      c.code === 'Escape' && n != '/' && (r(0, (l = false)), It(null), J('close'))
    }
    function u() {
      J('toggleKeepInput')
    }
