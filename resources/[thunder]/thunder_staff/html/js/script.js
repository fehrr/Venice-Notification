    ...
    document.onkeyup = function(data) {
        if (data.which == 27) {
            if ($("body center").is(":visible")) {
                ...
                $.post("https://thunder_staff/close");
            }
        }
    };
...
$(document).on("click", ".paineladm .conteudo .players .dadosplayer .dadospersonagem .cargos .ativos .removercargo", function(e) {
    ...
    $.post("https://thunder_staff/remgroup", JSON.stringify({ id: user_id, group: group }), function(data) {
        if (data) {
            loaduserdata(user_id)
...
$(document).on("click", ".cargos-select .input button", function(e) {
    ...
    $.post("https://thunder_staff/addgroup", JSON.stringify({ id: user_id, group: group }), function(data) {
        if (data) {
            loaduserdata(user_id);
            $("body center").hide();
...
$(document).on("click", ".adv-ban .input button", function(e) {
    ...
    time = parseInt(time)
    if (time > 0){
        $.post("https://thunder_staff/addban", JSON.stringify({ id: user_id, time: time }), function(data) {
            if (data) {
                loaduserwarnings(user_id);
                $("body center").hide();
...
$(document).on("click", ".adv-reason .input button", function(e) {
    ...
    if (reason){
        $.post("https://thunder_staff/addwarning", JSON.stringify({ id: user_id, reason: reason }), function(data) {
            if (data) {
                loaduserwarnings(user_id);
                $("body center").hide();
...
$(document).on("click", ".adv-ban-edit .input button", function(e) {
    ...
    time = parseInt(time)
    if (time > 0){
        $.post("https://thunder_staff/editban", JSON.stringify({ id: id, time: time }), function(data) {
            if (data) {
                loaduserwarnings(user_id);
                $("body center").hide();
...
$(document).on("click", ".paineladm .conteudo .banimentos .banadv .acoesbanadv .deletar", function(e) {
    var id = $(this).attr("data-id");
    var user_id = $(this).attr("data-user_id");
    $.post("https://thunder_staff/deletewarning", JSON.stringify({ id: id }), function(data) {
        if (data) {
            loaduserwarnings(user_id);
            $("body center").hide();
...
$(document).on("click", ".paineladm .conteudo .mensagens .msgprivadas .chat-input-wrapper .chat-send-btn", function(e) {
    ...
    $.post("https://thunder_staff/sendmessage", JSON.stringify({ id: user_id, message: message }), function(data) {
        if (data) {
            loadusermessages(user_id);
...
$(document).on("click", ".paineladm .conteudo .spawnitens .staffspawn button", function(e) {
    ...
    $.post("https://thunder_staff/spawnitem", JSON.stringify({ item: item, amount: amount }), function(data) {
        if (data) {
            $("body center").hide();
...
$(document).on("click", ".paineladm .conteudo .spawnitens .playerspawn button", function(e) {
    ...
    $.post("https://thunder_staff/spawnitem", JSON.stringify({ item: itemplayer, amount: amount, id: user_id }), function(data) {
        if (data) {
            $("body center").hide();
            createAlert("success", "Sucesso", "Item spawnado com sucesso", 3000);
        } else {
...
$(document).on("click", ".spawn-vehicle .input .spawnvehicle", function(e) {
    ...
    $.post("https://thunder_staff/spawnvehicle", JSON.stringify({ id: user_id, vehicle: vehicle }), function(data) {
        if (data) {
            $("body center").hide();
...
$(document).on("click", ".spawn-vehicle .input .addvehicle", function(e) {
    ...
    $.post("https://thunder_staff/addvehicle", JSON.stringify({ id: user_id, vehicle: vehicle }), function(data) {
        if (data) {
            $("body center").hide();
...
$(document).on("click", ".playerchat .chatativo .chat-input-wrapper .chat-send-btn", function(e) {
    ...
    $.post("https://thunder_staff/sendmessageplayer", JSON.stringify({ message: message }), function(data) {
        if (data) {
...
function loadstaff(data){
    ...
    $(".paineladm .opcoes .dados .nome").html(data.nome+" #"+data.user_id);
    perms = data.perms
...
function loaduserdata(user_id) {
    $.post("https://thunder_staff/getuser", JSON.stringify({ id: user_id }), function(data) {
        if (data) {
...
function loadusermessages(user_id) {
    $.post("https://thunder_staff/getmessages", JSON.stringify({ id: user_id }), function(data) {
        if (data) {
