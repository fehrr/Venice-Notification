            ...
            <header>
                ...
                <nav>
                    <button @click="changeRanking('Geral')" class="btn-all"
                        :class="{ 'active-btn': activeRanking === 'Geral' }">GERAL</button>
                    <div class="navbar-wrapper">
                        ...
                        <button @click="changeRanking('Contrabando')" :class="{ 'active-btn': activeRanking === 'Contrabando' }"
                            class="nav-btn">CONTRABANDO</button>
                    </div>
                </nav>
            </header>
            <main>
