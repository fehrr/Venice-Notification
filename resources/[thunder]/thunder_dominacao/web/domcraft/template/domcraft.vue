...
.item::before {
    ...
    width: 120%;
    height: 120%;
    background: radial-gradient(73.36% 223.6% at -3.81% 47.6%, rgba(0, 80, 205, 0.2) 0%, rgba(0, 100, 255, 0) 100%);
    opacity: 0;
...
.notify {
    ...
    background: radial-gradient(73.36% 223.6% at -3.81% 47.6%, rgba(0, 80, 205, 0.2) 0%, rgba(0, 100, 255, 0) 100%), #101010;
    border-radius: 0.521vw;
    display: flex;
    flex-direction: column;
    justify-content: center;
