...
RegisterNetEvent("cinematicCam:start")
AddEventHandler("cinematicCam:start", function()
    if not DoesCamExist(cam) then
        ToggleCam(true, GetGameplayCamFov())
    end
end)

RegisterNetEvent("cinematicCam:stop")
AddEventHandler("cinematicCam:stop", function()
    ToggleCam(false, GetGameplayCamFov())
