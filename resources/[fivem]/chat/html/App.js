window.APP = {
    ...
    data() {
        return {
            ...
            shouldHide: true, // true
            focusOn: false,
            backingSuggestions: [],
            removedSuggestions: [],
            templates: CONFIG.templates,
            message: '',
            messages: [/* { args: ['DICA', 'Nem só empregos legais geram dinheiro! Nem só empregos legais geram dinheiro!  legais geram dinheiro! Nem só empregos legais geram dinheiro! Nem só empregos legais geram dinheiro!'], type: 'paramedico', color: [10, 50, 100], multiline: true }, 
            { args: ['DICA', 'Nem só empregos legais geram dinheiro!'], type: 'box', color: [10, 50, 100], multiline: true },
            { args: ['DICA', 'Nem só empregos legais geram dinheiro!'], type: 'staff', color: [10, 50, 100], multiline: true },
            { args: ['DICA', 'Nem só empregos legais geram dinheiro!'], type: 'mr', color: [10, 50, 100], multiline: true }, */ 
    ...
    methods: {
        ...
        ON_OPEN() {
            ...
            this.focusTimer = setInterval(() => {
                if (this.$refs.input && this.focusOn == false) {
...
tickerMessages = [
    `COMPRE VIPS, CARROS E MUITO MAIS NA NOSSA LOJA COM 15% DE DESCONTO. CUPOM: <span style="color: rgb(255, 255, 255);"> FUSION50</span>`,
];
...
updateTicker = function () {
    ...
    if (ticker == null) {
        ...
        div.setAttribute("style", "padding: 8px;background: rgba(0, 0, 0, 0.2); border-bottom: 2px solid rgb(255, 255, 255);");
