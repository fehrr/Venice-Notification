...
(function (factory) {
    if ( true && typeof module.exports === "object") {
        var v = factory(__webpack_require__(2999), exports);
...
// EXTERNAL MODULE: ./node_modules/connection-string-parser/dist/connection-string-parser.js
var connection_string_parser = __webpack_require__(8545);
...
const createConnection = () => {
  if (connectionString.includes('host=')) {
    ...
    const options = new connection_string_parser.ConnectionStringParser({
      scheme: 'mysql',
      hosts: [],
...
setImmediate(async () => {
  try {
    ...
    console.log(`^2Banco de Dados conectado com sucesso!^0`);
  } catch (error) {
    console.log(`^3Problema para conectar com banco de dados! [${error.code}]\n${error.message}^0`);
  }
});
