...
$(document).ready(function () {
  $.post("https://Venice-Notification/Ready", JSON.stringify({}));
});

$(document).on("click", ".Exit-button", function () {
  $("#notification-settings").fadeOut(500);
  $.post("https://Venice-Notification/Close", JSON.stringify({}));
});

$(document).on("click", ".top-placeholder", function () {
  $.post(
    "https://Venice-Notification/SelectPosition",
    JSON.stringify({
      position: "top",
    })
  );
...
$(document).on("click", ".Display-Notifications", function () {
  $.post("https://Venice-Notification/ActiveNotifications");
});

$(document).on("click", ".Hide-Notifications", function () {
  $.post("https://Venice-Notification/HideNotifications");
});
$(document).on("click", ".Enable-sound", function () {
  $.post("https://Venice-Notification/EnableSound");
});

$(document).on("click", ".Disable-sound", function () {
  $.post("https://Venice-Notification/DisableSound");
});
